...
const getStyles = (colors: ReturnType<typeof useThemeColors>) => StyleSheet.create({
  ...
  googleButton: { width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: colors.background, paddingVertical: 16, paddingHorizontal: 20, borderRadius: 12, borderWidth: 1, borderColor: colors.border },
  googleButtonDisabled: { opacity: 0.6 },
  googleButtonText: { color: colors.textPrimary, fontWeight: '800', fontSize: 13, letterSpacing: 2, textTransform: 'uppercase' },
  googleIconWrapper: { width: 20, height: 20, borderRadius: 10, backgroundColor: colors.card, alignItems: 'center', justifyContent: 'center', marginRight: 12, borderWidth: 1, borderColor: colors.border },
